...
export default class PathfindingVisualizer extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      currentAlgorithm: -1,
      algorithms: ["Dijkstra", "A Star", "BFS", "DFS"],
      pathfindingAlgorithms: [dijkstra, AStar, BFS, DFS],
      currentSpeed: "medium",
      speeds: { fast: 10, medium: 15, slow: 20 },
      mazeSpeed: 18,
    };
                  ...
                  <ul class='dropdown-menu' aria-labelledby='navbarDropdown'>
                    ...
                    <li>
                      <button
                        ...
                        onClick={() =>
                          this.setAlgorithm(
                            this.state.algorithms.indexOf("A Star")
                          )
                        }
                      >
                        A Star
          ...
          <div class='modal-dialog' id='dialog' role='document'>
            <div class='modal-content intro' id='modal-content'>
              <div class='modal-header'>
                <h3 class='modal-title'>Greetings Sitara Ma'am 😃 </h3>
              ...
              <div class='modal-body intro'>
                ...
                <p>
                  ...
                  <ul>
                    <li>
                  The paths pass from start to the target.</li>
                  <br></br>
                  <li>
